        ...
        <div className="about__content">
          <div className="about__cards">
            ...
            <article className="about__card tree">
              ...
              <h5>Hobby</h5>
              <small>Make a Program and Drawing</small>
            </article>
          </div>

          <p>
            Hallo, I'm Aap Hapipah. I'm a student of Information System in
            Universitas Bina Sarana Informatika. I ever studied Program Front
            End Web and React in Dicoding Indonesia.
          </p>
